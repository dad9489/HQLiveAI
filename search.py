...
def google_search(query):
    """
    Searches google for the query and returns a list of all of the descriptions from the first page of google
    :param query:
    :return:
    """
...
# google_search("Scoring at least 10 points, rebounds, and assists in basketball is called a what?")